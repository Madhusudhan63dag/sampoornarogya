...
// Centralized blog data - only 3 dummy blog posts


export const blogPosts = [
  {
    id: 1,
    slug: "Ayurvedic-Herbs-Digestion-Immunity",
    title: "Top Ayurvedic Herbs for Digestion and Immunity",
    excerpt: "Ayurvedic herbs for digestion & immunity that support natural healing, improve gut health, and strengthen immune function—backed by tradition.",
    content: `
  ...
  {
    id: 2,
    slug: "Digestive-health-detoxification",
    title: "Ayurvedic Guide to Better Digestive Health & Detoxification",
    excerpt: "Ayurveda boosts digestive health and detoxification using herbs, diet, and rituals that ignite Agni and clear toxins for Active and energetic.",
    content: `
...
// Blog categories derived from the posts
export const categories = ['All', 'Science', 'Health Tips', 'Ingredients'];

// Related posts for individual blog pages
...
// Helper function to generate static params for Next.js
